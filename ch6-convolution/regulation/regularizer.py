...
print("출력 형식 : [Data augumentaion - Dropout - L2 regularizer] (교차검증 시도/평균)")
...
plt.grid()
plt.boxplot([acc_000,acc_001,acc_010,acc_011,acc_100,acc_101,acc_110,acc_111],labels=["000",])