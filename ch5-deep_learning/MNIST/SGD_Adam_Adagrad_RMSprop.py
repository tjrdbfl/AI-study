...
dmlp_adam.compile(loss='categorical_crossentropy',optimizer=Adam(),metric=['accuracy'])
...
dmlp_adagrad.compile(loss='categorical_crossentropy',optimizer=Adagrad(),metric=['accuracy'])
...
dmlp_rmsprop.compile(loss='categorical_crossentropy',optimizers=RMSprop(),metrics=['accuracy'])
...
plt.legend(['Train_sgd','Val_sgd','Train_adam','Val_adam',
            'Train_adagrad','Val_adagrad','Train_rmsprop','Val_rmsprop'], loc='best')
plt.grid()
plt.show()