...
hist_ce=dmlp_ce.fit(x_train,y_train,batch_size=128,validation_data=(x_test,y_test),epochs=30,verbose=2)
...
print("교차 엔트로피의 정확률", res_ce[1]*100)
